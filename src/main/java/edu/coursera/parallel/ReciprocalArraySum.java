...
public final class ReciprocalArraySum {
    ...
    protected static double parArraySum(final double[] input) {
        ...
        // Compute sum of reciprocals of array elements
        ReciprocalArraySumTask upper = new ReciprocalArraySumTask(0, length, input);
        ReciprocalArraySumTask lower = new ReciprocalArraySumTask(length, input.length, input);
        upper.fork();
        lower.compute();
        upper.join();
